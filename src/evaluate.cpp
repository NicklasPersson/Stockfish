...
namespace {
  ...
  const int KingAttackWeights[] = { 0, 0, 8, 1, 4, 0 };

  // Bonuses for enemy's safe checks
  const int QueenContactCheck = 87;
  const int RookContactCheck  = 73;
  const int QueenCheck        = 52;
  const int RookCheck         = 40;
