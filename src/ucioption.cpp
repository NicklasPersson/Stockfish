...
void init(OptionsMap& o) {
  ...
  o["QueenContactCheck"] << Option(0, 0, 200, on_spsa);
  o["RookContactCheck"] << Option(0, 0, 200, on_spsa);
  o["QueenCheck"] << Option(0, 0, 200, on_spsa);
  o["RookCheck"] << Option(0, 0, 200, on_spsa);
  o["BishopCheck"] << Option(0, 0, 200, on_spsa);
  o["KnightCheck"] << Option(0, 0, 200, on_spsa);
  o["AUmax"] << Option(0, 0, 200, on_spsa);
  o["AUzone"] << Option(0, 0, 80, on_spsa);
  o["AUundefended"] << Option(0, 0, 80, on_spsa);
  o["AUpinned"] << Option(0, 0, 80, on_spsa);
  o["AUscoreFactor"] << Option(0, 0, 256, on_spsa);
  o["AUnoQueen"] << Option(0, 0, 200, on_spsa);
 
  o["KDMaxSlope"] << Option(0, 0, 200, on_spsa);
  o["KDPeak"] << Option(0, 0, 2000, on_spsa);
  o["KDFactor"] << Option(0, 0, 200, on_spsa);
  }
